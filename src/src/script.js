...
const projects = [
  {
    id: "project1",
    title:"Tokyo Table",
    img:"/Portfolio_OJT/img/tokyotable.png",
  ...
  },
  {
    id: "project4",
    title:"Logo",
    img:"/Portfolio_OJT/img/logo.png",
  ...
  },
  {
    ...
    img:"/Portfolio_OJT/img/businesscard.png",
  ...
  },
  {
    ...
    img:"/Portfolio_OJT/img/tailwind.png",
  ...
  modal.innerHTML = `
    ...
    <div class="modal-content shadow-lg border-0 rounded-4">
      ...
      <div class="text-center row text-start fs-6">
          ...
          <div class="col-md-6 mb-5">
            <strong>Role/Contribution:</strong><br>
